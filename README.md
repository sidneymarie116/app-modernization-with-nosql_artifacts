...
* [Visual Studio solution](ContosoMoviesApp/Contoso.Apps.Movies.sln)
...
* [SQL database documentation](DatabaseSchema/README.md)
* [Database diagram](DatabaseSchema/database-diagram.png)
